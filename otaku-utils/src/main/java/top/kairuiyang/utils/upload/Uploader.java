...
public class Uploader {
    ...
    List<UploadFile> saveUploadFileList;
    private final StandardMultipartHttpServletRequest request;

    /**
     * 文件允许格式
     */
    private final String[] allowFiles = {".rar", ".doc", ".docx", ".zip", ".pdf", ".txt", ".swf", ".wmv", ".gif", ".png", ".jpg", ".jpeg", ".bmp", "blob", ".mp4"};
