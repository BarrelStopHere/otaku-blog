package top.kairuiyang.admin.annotion.AvoidRepeatableCommit;
...
public class AvoidRepeatableCommitAspect {
     ...
     * @param point
     */
    @Around("@annotation(top.kairuiyang.admin.annotion.AvoidRepeatableCommit.AvoidRepeatableCommit)")
